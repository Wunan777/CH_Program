  ...
  function Section($el, parent) {
    $.extend(this, {
      ...
      $summary : $el
        ...
        .wrapInner('<a href="#" style="background: url("../images/sprite.png") 15px 13px no-repeat;display: block;padding: 10px;padding-left: 32px;margin: 0;color: #fff;text-decoration: none;font-weight: normal;border-bottom: 1px solid rgba(28,136,175, 0.5);text-shadow: 1px 1px 1px rgb(28,136,175);"/>'),
      $details : $el.next(),
